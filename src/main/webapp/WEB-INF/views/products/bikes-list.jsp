...
<div class="m-4 p-3 width-medium">
    <div class="dashboard-content border-dashed p-3 m-4 view-height">
        <div class="row border-bottom border-3 p-1 m-1">
            <div class="col noPadding"><h3 class="color-header text-uppercase">ROWERY</h3></div>
        ...
        <table class="table border-bottom schedules-content">
            ...
            <c:forEach var="bike" items="${bikes}">
                <tr class="d-flex">
                    <th scope="row" class="col-2">${bike.producer}, model: ${bike.model} </th>
                    <td class="col-1">${bike.price}</td>
                    <td class="col-7">${bike.description}</td>
                    <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                        <a href="<c:url value="/products/details/${bike.id}"/>"
                           class="btn btn-info rounded-0 text-light m-1">Szczegóły</a>
                        <a href="<c:url value="/admin/products/edit/bike?id=${bike.id}"/>"
